...
$.extend($.validator, {
	...
	messages: {
		required: "<br /><span style='color:#C00;'>Este campo &eacute; obrigat&oacute;rio</span><br />",
...
jQuery.validator.addMethod("cpf", function(value, element) {
   value = jQuery.trim(value);
	...
	return true;
}, "<br /><span style='color:#C00 !important;'>Informe um CPF v&aacute;lido</span><br />"); // Mensagem padrão 
...
}, "<br /><span style='color:#C00 !important;'>Informe um CNPJ v&aacute;lido</span><br />"); // Mensagem padrão 
