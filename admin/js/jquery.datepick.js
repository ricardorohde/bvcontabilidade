...
function Datepick() {
	...
	this.regional[''] = { // Default regional settings
		...
		clearStatus: 'Apagar data atual', // Status text for clear link
		closeText: 'Fechar', // Display text for close link
		closeStatus: 'Fechar sem mudan&ccedil;a', // Status text for close link
		prevText: '&#x3c;&#x3c;', // Display text for previous month link
		prevStatus: 'Mostrar m&ecirc;s anterior', // Status text for previous month link
		prevBigText: '&#x3c;&#x3c;', // Display text for previous year link
		prevBigStatus: 'Mostrar ano anterior', // Status text for previous year link
		nextText: '&#x3e;&#x3e;', // Display text for next month link
		nextStatus: 'Mostrar pr&oacute;ximo m&ecirc;s', // Status text for next month link
		nextBigText: '&#x3e;&#x3e;', // Display text for next year link
		nextBigStatus: 'Mostrar pr&oacute;ximo ano', // Status text for next year link
		currentText: 'Hoje', // Display text for current month link
		currentStatus: 'Mostrar m&ecirc;s atual', // Status text for current month link
