...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Exibir _MENU_ itens",sZeroRecords:"Nenhum resultado encontrado",sEmptyTable:"No data available in table",sInfo:"Exibindo _START_ de _END_ de um total de _TOTAL_ itens",sInfoEmpty:"Exibindo 0 de 0 de 0 intens",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"Pesquisar por Nome:",sUrl:"",oPaginate:{sFirst:"Primeiro",sPrevious:"Anterior",sNext:"Pr&oacute;ximo",sLast:"&Uacute;ltimo"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=
