...
$(function(){
	...
	$("select[name='tipo_jornada']").change(function(){
		...
		if(tipojor == "normal" || tipojor == "")
		{
			...
			$("input[name='entrada_2_s']").removeClass("required");
			$("input[name='saida_2_s']").removeClass("required");
			$("input[name='entrada_2_d']").removeClass("required");
			$("input[name='saida_2_d']").removeClass("required");
	...
	$("select[name='pegaempresa-cond']").change(function(){
		...
		$.post("paginas/ponto/pegaempresa.php",{
				...
				$("input[name='id_empresa']").val(dados[0]);
...
<form action="paginas/ponto/acoes.php?op=novo&id=<?php echo $id;?>" method="post" id="formcadastro" enctype="multipart/form-data">
	<table cellpadding="0" cellspacing="2" width="100%" class="tblcadastro">
        <tr>
            ...
            <select name="pegaempresa-cond" class="inputbox"  style="width:220px;">
            ...
            <input type="hidden" name="id_empresa" value="<?php echo @$reg['id_empresa'];?>" />
        ...
        <tr>
			<td valign="top">E-mail <small> - insira mais e-mails separando com ;</small><br /><input type="text" name="email" value="<?php echo @$reg['email'];?>" class="inputbox required" style="width:430px;" /></td>
        ...
        <tr>
            ...
            De: <input type="text" name="data_de" value="<?php echo @$reg['data_de'] ? date("d/m/Y",strtotime("+1 month",strtotime(@$reg['data_de']))) : "19/".date("m/Y");?>" class="inputbox required datamascara" placeholder="DD/MM/AAAA" style="width:225px;" />&nbsp;
            At&eacute;: <input type="text" name="data_ate" value="<?php echo @$reg['data_de'] ? date("d/m/Y",strtotime("+1 month",strtotime(@$reg['data_ate']))) : "20/".date('m', strtotime("+1 month",strtotime(date('Y-m-d'))))."/".date("Y");?>" class="inputbox required datamascara" placeholder="DD/MM/AAAA" style="width:225px;" /></td>         
        </tr>
        ...
        <tr>
        	<td colspan="2">
            	<table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr class="l1">
						<td>SEG</td>
						<td align="center"><input type="text" name="entrada_1_1" value="<?php echo @$reg['entrada_1_1'];?>" placeholder="--:--" class="inputbox hora entrada_1 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="saida_1_1" value="<?php echo @$reg['saida_1_1'];?>" placeholder="--:--" class="inputbox hora saida_1 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="entrada_2_1" value="<?php echo @$reg['entrada_2_1'];?>" placeholder="--:--" class="inputbox hora entrada_2 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="saida_2_1" value="<?php echo @$reg['saida_2_1'];?>" placeholder="--:--" class="inputbox hora saida_2 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="carga_horaria_1" value="<?php echo @$reg['carga_horaria_1'];?>" placeholder="--:--" class="inputbox hora carga_horaria " style="width: 50px; text-align:center;" /></td>
					</tr>
                    <tr class="l4">
						<td>TER</td>
						<td align="center"><input type="text" name="entrada_1_2" value="<?php echo @$reg['entrada_1_2'];?>" placeholder="--:--" class="inputbox hora entrada_1 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="saida_1_2" value="<?php echo @$reg['saida_1_2'];?>" placeholder="--:--" class="inputbox hora saida_1 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="entrada_2_2" value="<?php echo @$reg['entrada_2_2'];?>" placeholder="--:--" class="inputbox hora entrada_2 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="saida_2_2" value="<?php echo @$reg['saida_2_2'];?>" placeholder="--:--" class="inputbox hora saida_2 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="carga_horaria_2" value="<?php echo @$reg['carga_horaria_2'];?>" placeholder="--:--" class="inputbox hora carga_horaria " style="width: 50px; text-align:center;" /></td>
					</tr>
					<tr class="l5">
						<td>QUA</td>
						<td align="center"><input type="text" name="entrada_1_3" value="<?php echo @$reg['entrada_1_3'];?>" placeholder="--:--" class="inputbox hora entrada_1 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="saida_1_3" value="<?php echo @$reg['saida_1_3'];?>" placeholder="--:--" class="inputbox hora saida_1 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="entrada_2_3" value="<?php echo @$reg['entrada_2_3'];?>" placeholder="--:--" class="inputbox hora entrada_2 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="saida_2_3" value="<?php echo @$reg['saida_2_3'];?>" placeholder="--:--" class="inputbox hora saida_2 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="carga_horaria_3" value="<?php echo @$reg['carga_horaria_3'];?>" placeholder="--:--" class="inputbox hora carga_horaria " style="width: 50px; text-align:center;" /></td>
					</tr>
					<tr class="l6">
						<td>QUI</td>
						<td align="center"><input type="text" name="entrada_1_4" value="<?php echo @$reg['entrada_1_4'];?>" placeholder="--:--" class="inputbox hora entrada_1 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="saida_1_4" value="<?php echo @$reg['saida_1_4'];?>" placeholder="--:--" class="inputbox hora saida_1 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="entrada_2_4" value="<?php echo @$reg['entrada_2_4'];?>" placeholder="--:--" class="inputbox hora entrada_2 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="saida_2_4" value="<?php echo @$reg['saida_2_4'];?>" placeholder="--:--" class="inputbox hora saida_2 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="carga_horaria_4" value="<?php echo @$reg['carga_horaria_4'];?>" placeholder="--:--" class="inputbox hora carga_horaria " style="width: 50px; text-align:center;" /></td>
					</tr>
					<tr class="l7">
						<td>SEX</td>
						<td align="center"><input type="text" name="entrada_1_5" value="<?php echo @$reg['entrada_1_5'];?>" placeholder="--:--" class="inputbox hora entrada_1 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="saida_1_5" value="<?php echo @$reg['saida_1_5'];?>" placeholder="--:--" class="inputbox hora saida_1 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="entrada_2_5" value="<?php echo @$reg['entrada_2_5'];?>" placeholder="--:--" class="inputbox hora entrada_2 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="saida_2_5" value="<?php echo @$reg['saida_2_5'];?>" placeholder="--:--" class="inputbox hora saida_2 " style="width: 50px; text-align:center;" /></td>
						<td align="center"><input type="text" name="carga_horaria_5" value="<?php echo @$reg['carga_horaria_5'];?>" placeholder="--:--" class="inputbox hora carga_horaria " style="width: 50px; text-align:center;" /></td>
					</tr>
                </table>
            </td>
        </tr>
