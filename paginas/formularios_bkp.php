	...
	<table cellpadding="10" cellspacing="0" width="100%" class="tblform">
        ...
        <tr class="form1 pdbvsim esconde">
        	<td valign="top" colspan="2" align="center">Declarou ano passado?<br />
            	<label><input type="radio" class="required" name="bvdeanopassado" value="sim" /> Sim</label>&nbsp;&nbsp;&nbsp;
        ...
        <tr class="form2 pdbvnao esconde">
        	<td valign="top" colspan="2" align="center">Declarou ano passado?<br />
            	<label><input type="radio" class="required" name="nbvdeanopassado" value="sim" /> Sim</label>&nbsp;&nbsp;&nbsp;
                <label><input type="radio" name="nbvdeanopassado" value="nao" /> N&atilde;o</label>
          	</td>
       	</tr>
        <tr class="form2 nbvdeanopassadosim esconde">
...
<form action="paginas/envia.php?op=avisoprevio" method="post" id="formularios">
	...
	<table cellpadding="10" cellspacing="0" width="100%" class="tblform">
        ...
        <tr>
        	<td colspan="2">Data do pagamento das verbas rescis&oacute;rias:<br /><input type="text" name="data_pagamento" readonly class="inputbox required" style="width: 250px;" /></td>
        </tr>
        
        <tr class="trabalhado">
        	<td colspan="2">Faltar os &uacute;ltimos: 
            	<select name="numdias" class="inputbox">
                	<option selected='selected' value="7">7</option>
                    <option value="10">10</option>
                </select> dias corridos <small>(opcional)</small></td>
        </tr>
...
<?php
	...
	<form action="index.php?pag=formularios&cat=calchoraextra&passo=2" method="post" id="formularios">
		...
		<table cellpadding="10" cellspacing="0" width="100%" class="tblform">
			...
			<tr><td colspan="2"><hr /></td></tr>
			<tr>
				<td valign="top" colspan="2" align="center">Tipo de Jornada de Trabalho: &nbsp;&nbsp;
			...
			<tr>
				<td colspan="2">
					<table cellpadding="0" cellspacing="0" width="100%">
						...
						<tr class="l1">
							<td>SEG</td>
							<td align="center" style="background: #111; border:1px solid #000 !important;"><input type="text" name="entrada_1" placeholder="--:--" class="inputbox hora entrada_1 required" style="width: 50px; text-align:center; background: #000;" /></td>
							<td align="center" style="background: #111; border:1px solid #000 !important; border-right:5px solid #000 !important;"><input type="text" name="saida_1" placeholder="--:--" class="inputbox hora saida_1 required" style="width: 50px; text-align:center; background: #000;" /></td>
							<td align="center" style="background: #111; border:1px solid #000 !important;"><input type="text" name="entrada_2" placeholder="--:--" class="inputbox hora entrada_2 required" style="width: 50px; text-align:center; background: #000;" /></td>
							<td align="center" style="background: #111; border:1px solid #000 !important; border-right:5px solid #000 !important;"><input type="text" name="saida_2" placeholder="--:--" class="inputbox hora saida_2 required" style="width: 50px; text-align:center; background: #000;" /></td>
							<td align="center" style="background: #111; border:1px solid #000 !important;"><input type="text" name="carga_horaria" placeholder="--:--" class="inputbox hora carga_horaria required" style="width: 50px; text-align:center; background: #000;" /></td>
						</tr>
						<tr class="l4">
							<td>TER</td>
							<td align="center" style="background: #111; border:1px solid #000 !important;"><input type="text" name="entrada_1" placeholder="--:--" class="inputbox hora entrada_1 required" style="width: 50px; text-align:center; background: #000;" /></td>
